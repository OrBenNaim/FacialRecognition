#================== Paths to files ======================
DATA_PATH_FOLDER = './DATA/LFW-a'  # Path to LFW-a dataset
TRAIN_FILE_PATH = './DATA/pairsDevTrain.txt'  # Path to train.txt
TEST_FILE_PATH = './DATA/pairsDevTest.txt'  # Path to test.txt
SAVED_CACHE_DATASET_PATH = './dataset.pkl'
SAVED_IMG_DIR_PATH = './images'  # Path to save images directory
SAVED_MODEL_PATH = './best_model.pth'
SAVED_LOGS_PATH = './tensorboard_logs'
SAVED_REPORT_PATH = './test_results/final_test_evaluation_report.txt'
#============================================================
